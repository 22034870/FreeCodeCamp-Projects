...
# Clean data by filtering out the top and bottom 2.5%
df = df[
...
def draw_bar_plot():
    ...
    # Group by year and month, then unstack to create the grouped bar chart format
    df_bar = df_bar.groupby(['year', 'month'])['value'].mean().unstack()
    
    # Order the months correctly for the legend and bars
...
def draw_box_plot():
    ...
    # Define the order so the x-axis starts at Jan
